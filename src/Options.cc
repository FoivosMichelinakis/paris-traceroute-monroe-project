...
Options::Options (int argc, char** argv) {
  ...
  char* short_opts = "AZhVvQniDf:F:m:p:o:s:d:t:w:T:q:M:a:lb:L:B:c:E:r:C:O:";

  //Foivos parameters
  char *nodeIPArgument = new char[200];
  char *nodeInterfaceArgument = new char[200];
  //Foivos parameters
  ...
  while ((opt = getopt_long(argc, argv, short_opts, long_opts, NULL)) != -1) {
    ...
    //Foivos parameters
    case 'C':
    	strcpy(nodeIPArgument, optarg);
    	globalVariables::g_nodeIP = (char *) nodeIPArgument;
    	break;

    case 'O':
    	strcpy(nodeInterfaceArgument, optarg);
    	globalVariables::g_nodeInterface = (char *) nodeInterfaceArgument;
    	break;
    //Foivos parameters
